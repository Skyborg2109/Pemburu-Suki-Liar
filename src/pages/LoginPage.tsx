      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-blue-900/5 border border-gray-100 p-8 sm:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-1">Masuk ke akun Sinar Muda Anda</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold text-base shadow-lg shadow-blue-600/25 transition-all hover:shadow-blue-600/40 disabled:opacity-70"
            >
              {loading ? (
